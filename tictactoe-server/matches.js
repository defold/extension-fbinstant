...
module.exports = function(app) {
    ...
    validate = function(signedRequest) {
        ...
        try{
            ...
            var dataHash = crypto.HmacSHA256(signedRequest.split('.')[1], process.env.APP_SECRET).toString();
    ...
    getEncodedData = function(signedRequest) {
        ...
        try {
            ...
            var json = crypto.enc.Base64.parse(signedRequest.split('.')[1]).toString(crypto.enc.Utf8);
